...
public final class Constants {
    ...
    public final static String UNSUCCESSFUL_USER_CREATION_GUEST_PAGE = "";
    public final static String SUCCESSFUL_USER_CREATION = "/pages/user/create user/successful user creation.jsp";
    public final static String UNSUCCESSFUL_USER_CREATION = "";
    ...
    public static final String UNSUCCESSFUL_ROOM_CREATION = "";
    ...
    public final static String USER_IS_NOT_FOUND = "";
